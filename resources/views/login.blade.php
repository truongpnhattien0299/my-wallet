            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                @if ($errors->any())
                    ...
                    @endforeach
                @endif
                <form method="POST" action="{{ route('postLogin') }}" class="pt-3">
                    @csrf
                  <div class="form-group">
                    <input type="text" name="username" class="form-control form-control-lg" value="{{ old('username') }}" id="exampleInputEmail1" placeholder="Username">
                  </div>
                  <div class="form-group">
